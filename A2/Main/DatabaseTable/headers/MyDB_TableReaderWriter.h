...
public:
	...
	MyDB_RecordPtr getEmptyRecord (); // done
	...
	// access the pageNum^th page in this file
	MyDB_PageReaderWriter operator [] (size_t offset);

        // access the last page in the file
        MyDB_PageReaderWriter last ();

private:
    void initializePage(MyDB_TablePtr tablePtr,long offset);
